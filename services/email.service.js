...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:'Segoe UI',Arial,sans-serif;">
  ...
  <div style="max-width:600px;margin:20px auto;background:white;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.1);">

    <!-- Header -->
    <div style="background:linear-gradient(135deg,#0f172a,#1e3a5f);padding:24px 40px;text-align:center;">
    ...
    <!-- Success Banner -->
    <div style="background:linear-gradient(135deg,#10b981,#059669);padding:16px 40px;text-align:center;">
    ...
    <div style="padding:24px 40px;">
      ...
      <p style="color:#64748b;font-size:0.92rem;line-height:1.7;margin:0 0 14px;">
      ...
      <!-- Parking Info -->
      <div style="background:#f8fafc;border-radius:14px;padding:20px 24px;margin-bottom:14px;border:1px solid #f1f5f9;">
      ...
      <!-- Login Credentials -->
      <div style="background:linear-gradient(135deg,#eff6ff,#f0fdf4);border-radius:14px;padding:20px 24px;margin-bottom:14px;border:1.5px solid #bfdbfe;">
      ...
      <!-- Steps -->
      <div style="background:#fffbeb;border:1.5px solid #fde68a;border-radius:14px;padding:20px 24px;margin-bottom:14px;">
    ...
    <!-- Footer -->
    <div style="background:#f8fafc;padding:16px 40px;text-align:center;border-top:1px solid #f1f5f9;">
